        ...
        (a = function (e) {
          ...
          function o(a) {
            var r = a || window.event,
              ...
              m = 0;
            if (
              (((a = e.event.fix(r)).type = "mousewheel"),
              ...
              "deltaX" in r && ((u = r.deltaX), 0 === p && (o = -1 * u)),
              0 !== p || 0 !== u)
            ) {
              if (1 === r.deltaMode) {
              ...
              if (
                ...
                (!i || f < i) && ((i = f), c(r, f) && (i /= 40)),
                c(r, f) && ((o /= 40), (u /= 40), (p /= 40)),
                ...
                (h = a.clientX - w.left), (m = a.clientY - w.top);
              }
              return (
                (a.deltaX = u),
                (a.deltaY = p),
          ...
          (a = i.amdO),
                    ...
                    if (!i.data("mCS")) {
                      ...
                      n && (r.axis = n),
                        ...
                        a &&
                          ...
                          "function" == typeof r.callbacks.onCreate &&
                          r.callbacks.onCreate.call(this),
                        t(
                          "#mCSB_" +
                            a.idx +
                            "_container img:not(.mCS_img_loaded)"
                        ).addClass("mCS_img_loaded"),
                ...
                return t(a).each(function () {
                  ...
                  if (e.data("mCS")) {
                    var a = e.data("mCS"),
                      ...
                      s = t("#mCSB_" + a.idx),
                      l = [
                        t("#mCSB_" + a.idx + "_dragger_vertical"),
                        t("#mCSB_" + a.idx + "_dragger_horizontal"),
                      ];
                    if (!n.length) return;
                    a.tweenRunning && K(e),
                      i &&
                      ...
                      e.hasClass("mCS_disabled") &&
                        e.removeClass("mCS_disabled"),
                      e.hasClass("mCS_destroyed") &&
                        e.removeClass("mCS_destroyed"),
                ...
                return t(e).each(function () {
                  ...
                  if (i.data("mCS")) {
                    ...
                    r.live && v(r.liveSelector || t(e).selector),
                      ...
                      o.remove(),
                      s
                        .find("img.mCS_img_loaded")
                        .removeClass("mCS_img_loaded"),
            ...
            (S = function () {
              var e = t(this),
                ...
                s =
                  "yx" === a.axis
                    ...
                    : "mCSB_vertical",
                o =
                  "yx" === a.axis ? n[0] + n[1] : "x" === a.axis ? n[1] : n[0],
                d =
                  "yx" === a.axis
                    ? "<div id='mCSB_" +
                      i.idx +
              ...
              a.setWidth && e.css("width", a.setWidth),
                ...
                (a.setLeft =
                  "y" !== a.axis && "rtl" === i.langDir
                    ? "989999px"
                    : a.setLeft),
                e
                  .addClass(l + " _mCS_" + i.idx + c + u)
                  .wrapInner(
                    "<div id='mCSB_" +
                      i.idx +
              ...
              "y" === a.axis ||
                ...
                "outside" === a.scrollbarPosition
                  ? ("static" === e.css("position") &&
                    ...
                    p.addClass("mCSB_outside").after(o))
                  : (p.addClass("mCSB_inside").append(o), f.wrap(d)),
                C.call(this);
              var h = [
              ...
              if (i.advanced.autoExpandHorizontalScroll && "y" !== i.axis) {
                ...
                (2 !== i.advanced.autoExpandHorizontalScroll &&
                  ...
                  : a
                      ...
                      .css({
                        width:
                          Math.ceil(a[0].getBoundingClientRect().right + 0.4) -
            ...
            (C = function () {
              var e = t(this).data("mCS"),
                ...
                r = er(i.scrollButtons.tabindex)
                  ? "tabindex='" + i.scrollButtons.tabindex + "'"
                  : "",
                n = [
                  "<a href='#' class='mCSB_buttonUp' " + r + " />",
                  "<a href='#' class='mCSB_buttonDown' " + r + " />",
                  "<a href='#' class='mCSB_buttonLeft' " + r + " />",
                  "<a href='#' class='mCSB_buttonRight' " + r + " />",
                ],
                s = [
                  "x" === i.axis ? n[2] : n[0],
                  "x" === i.axis ? n[3] : n[1],
            ...
            (E = function () {
              var e = t(this).data("mCS"),
                ...
                n = [
                  i.height() / a.outerHeight(!1),
                  i.width() / a.outerWidth(!1),
                ],
                s = [
                  parseInt(r[0].css("min-height")),
                  Math.round(n[0] * r[0].parent().height()),
                  parseInt(r[1].css("min-width")),
                  Math.round(n[1] * r[1].parent().width()),
                ],
                l = p && s[1] < s[0] ? s[0] : s[1],
                o = p && s[3] < s[2] ? s[2] : s[3];
              r[0]
                .css({ height: l, "max-height": r[0].parent().height() - 10 })
                .find(".mCSB_dragger_bar")
                .css({ "line-height": s[0] + "px" }),
                r[1].css({ width: o, "max-width": r[1].parent().width() - 10 });
            }),
            (T = function () {
              var e = t(this).data("mCS"),
                i = t("#mCSB_" + e.idx),
                ...
                n = [
                  a.outerHeight(!1) - i.height(),
                  a.outerWidth(!1) - i.width(),
                ],
                s = [
                  n[0] / (r[0].parent().height() - r[0].height()),
                  n[1] / (r[1].parent().width() - r[1].width()),
                ];
            ...
            (_ = function (e, t, i) {
              ...
              "active" === t
                ? (e.toggleClass(
                    "mCSB_dragger_onDrag " +
                      (i ? "mCSB_dragger_onDrag_expanded" : "")
                  ),
                  a.toggleClass("mCSB_scrollTools_onDrag"),
                  (e[0]._draggable = e[0]._draggable ? 0 : 1))
                : e[0]._draggable ||
                  ("hide" === t
                    ? (e.removeClass("mCSB_dragger_onDrag"),
                      a.removeClass("mCSB_scrollTools_onDrag"))
                    : (e.addClass("mCSB_dragger_onDrag"),
            ...
            (k = function () {
              ...
              if (
                (K(e),
                (("x" !== a.axis && !i.overflowed[0]) ||
                  ("y" === a.axis && i.overflowed[0])) &&
                  (s[0].add(n).css("top", 0), Z(e, "_resetY")),
                ("y" !== a.axis && !i.overflowed[1]) ||
                  ("x" === a.axis && i.overflowed[1]))
              ) {
                var l = (dx = 0);
                "rtl" === i.langDir &&
                  (dx = Math.abs(
                    (l = r.width() - n.outerWidth(!1)) / i.scrollRatio.x
                  )),
                  n.css("left", l),
                  s[1].css("left", dx),
                  Z(e, "_resetX");
            ...
            (L = function (e) {
              var i = t(this),
                ...
                l = [
                  t("#mCSB_" + a.idx + "_scrollbar_vertical"),
                  t("#mCSB_" + a.idx + "_scrollbar_horizontal"),
                ],
              ...
              "x" !== r.axis &&
                ...
                a.overflowed[0] || a.overflowed[1]
                  ? i.removeClass("mCS_no_scrollbar")
            ...
            (B = function (e) {
              ...
              switch (i) {
                ...
                case "MSPointerUp":
                  return a
                    ? [
                        e.originalEvent.pageY - a[0] + r[0],
                        e.originalEvent.pageX - a[1] + r[1],
                        !1,
                      ]
                ...
                case "touchend":
                  ...
                  return e.target.ownerDocument !== document
                    ? [n.screenY, n.screenX, s > 1]
                    : [n.pageY, n.pageX, s > 1];
                default:
                  return a
                    ? [e.pageY - a[0] + r[0], e.pageX - a[1] + r[1], !1]
                    : [e.pageY, e.pageX, !1];
              }
            }),
            (A = function () {
              var e,
                ...
                d = t("#mCSB_" + n.idx + "_container"),
                c = t("#" + o[0] + ",#" + o[1]),
                u = s.advanced.releaseDraggableSelectors
                  ? c.add(t(s.advanced.releaseDraggableSelectors))
                  : c,
                h = s.advanced.extraDraggableSelectors
                  ? t(!H() || top.document).add(
              ...
              function m(t, i, a, l) {
                ...
                Z(r, u.toString(), { dir: c, drag: !0 });
              }
              c
                .bind("contextmenu." + l, function (e) {
                  e.preventDefault();
                })
                .bind(
                  "mousedown." +
                  ...
                  function (n) {
                    if (
                      (n.stopImmediatePropagation(), n.preventDefault(), ei(n))
                    ) {
                      (f = !0),
                        p &&
                ...
                t(document)
                  ...
                  .bind(
                    "mouseup." +
                      ...
                      l,
                    function (t) {
                      e && (_(e, "active", s.autoExpandScrollbar), (e = null)),
                        (f = !1),
            ...
            (I = function () {
              var e,
                ...
                S = "mCS_" + w.idx,
                y = t("#mCSB_" + w.idx),
                x = t("#mCSB_" + w.idx + "_container"),
                C = [
                  t("#mCSB_" + w.idx + "_dragger_vertical"),
                  t("#mCSB_" + w.idx + "_dragger_horizontal"),
                ],
                E = [],
                T = [],
              ...
              function A(t) {
                if (
                  ...
                  !f &&
                  !B(t)[2] &&
                  (b.documentTouchScroll || t.preventDefault(),
                  ...
                  if (
                    ...
                    var d = C[0].parent().height() - C[0].height(),
                      c =
                        i - n > 0 &&
                        n - i > -(d * w.scrollRatio.y) &&
                        (2 * M[3] < M[2] || "yx" === b.axis);
                  if (w.overflowed[1])
                    var u = C[1].parent().width() - C[1].width(),
                      h =
                        a - s > 0 &&
                        s - a > -(u * w.scrollRatio.x) &&
                        (2 * M[2] < M[3] || "yx" === b.axis);
                  c || h
                    ? (O || t.preventDefault(), (m = 1))
                    : ((g = 1), v.addClass("mCS_touch_action")),
                    O && t.preventDefault(),
                    (p =
                      "yx" === b.axis
                        ? [i - n, a - s]
              ...
              function I(e) {
                ...
                (s = 1), e.stopImmediatePropagation(), K(v), (l = Q());
                var t = y.offset();
                (r = B(e)[0] - t.top),
                  (n = B(e)[1] - t.left),
                  (E = []),
                ...
                if (ea(t) && !f && !B(t)[2]) {
                  ...
                  if (!(d - o > 30)) {
                    var v = "mcsEaseOut",
                      ...
                      M = [
                        Math.abs(
                          (c = S ? [a - C[0], s - C[1]] : [a - r, s - n])[0]
                        ),
                        Math.abs(c[1]),
                      ];
                    u = S ? [Math.abs(c[0] / 4), Math.abs(c[1] / 4)] : [u, u];
                    var k = [
                      Math.abs(x[0].offsetTop) - c[0] * D(M[0] / u[0], u[0]),
                      Math.abs(x[0].offsetLeft) - c[1] * D(M[1] / u[1], u[1]),
                    ];
                    (p =
                      "yx" === b.axis
                        ? [k[0], k[1]]
                        ...
                        : [k[0], null]),
                      (h = [
                        4 * M[0] + b.scrollInertia,
                        4 * M[1] + b.scrollInertia,
                      ]);
              ...
              o.bind("mousedown." + l, function (t) {
                ...
                .bind("mousemove." + l, function (t) {
                  if (
                    ...
                    l > 0 && l < d.height() && u > 0 && u < d.width()
                      ? n.step && c("off", null, "stepped")
                      : ("x" !== r.axis &&
                          a.overflowed[0] &&
                          (l < 0 ? c("on", 38) : l > d.height() && c("on", 40)),
                        "y" !== r.axis &&
                          a.overflowed[1] &&
                          (u < 0 ? c("on", 37) : u > d.width() && c("on", 39)));
                  }
                })
                .bind("mouseup." + l + " dragend." + l, function (t) {
                  s || (e && ((e = 0), c("off", null)), (f = !1));
                });
            }),
            (D = function () {
              if (t(this).data("mCS")) {
                  ...
                  l.each(function () {
                    t(this).bind("load", function () {
                      H(this) &&
                        ...
                        ).bind("mousewheel." + r, function (e, t) {
                          o(e, t);
                        });
                    });
                  }),
                ...
                if ((K(e), !N(e, r.target))) {
                  ...
                  ("y" !== c || i.overflowed[0]) &&
                    ...
                    r.deltaFactor < 5 &&
                      ...
                      ((f = r.deltaFactor), (d = 17)),
                    Z(e, (h - v * f).toString(), { dir: c, dur: d }));
                }
              }
            }),
            ($ = {}),
            (H = function (e) {
              ...
              if (
                (void 0 === e
                  ? (a = "#empty")
                  : void 0 !== t(e).attr("id") && (a = t(e).attr("id")),
                !1 !== a && void 0 !== $[a])
              )
                return $[a];
              if (e) {
            ...
            (j = function () {
              var e,
                ...
                n = t("#mCSB_" + a.idx + "_container"),
                s = n.parent();
              t(".mCSB_" + a.idx + "_scrollbar .mCSB_draggerContainer")
                .bind(
                  "mousedown." +
                    r +
                    " touchstart." +
                ...
                .bind("click." + r, function (r) {
                  if (
                    e &&
                    ((e = 0),
                    t(r.target).hasClass("mCSB_draggerContainer") ||
                    ...
                    if (l.parent(".mCSB_scrollTools_horizontal").length > 0) {
                      ...
                      var d = "x",
                        ...
                        u = Math.abs(n[0].offsetLeft) - c * (0.9 * s.width());
                    } else {
                      if (!a.overflowed[0]) return;
                      var d = "y",
                        c = r.pageY > o.offset().top ? -1 : 1,
                        u = Math.abs(n[0].offsetTop) - c * (0.9 * s.height());
                    }
                    Z(i, u.toString(), {
                      dir: d,
                      scrollEasing: "mcsEaseInOut",
            ...
            (G = function () {
              ...
              n.bind("focusin." + r, function (i) {
                ...
                r.is(a.advanced.autoScrollOnFocus) &&
                  (K(e),
                  clearTimeout(e[0]._focusTimeout),
                  ...
                  (e[0]._focusTimeout = setTimeout(function () {
                    var t = [en(r)[0], en(r)[1]],
                      ...
                      l = [
                        i[0] + t[0] >= 0 &&
                          i[0] + t[0] < s.height() - r.outerHeight(!1),
                        i[1] + t[1] >= 0 &&
                          i[0] + t[1] < s.width() - r.outerWidth(!1),
                      ],
            ...
            (F = function () {
              var e = t(this),
                ...
                r = i.sequential,
                n = "mCS_" + i.idx;
              t(".mCSB_" + i.idx + "_scrollbar>a")
                .bind("contextmenu." + n, function (e) {
                  e.preventDefault();
                })
                .bind(
                  "mousedown." +
                    ...
                    if (
                      ...
                      if (
                        ...
                        if (
                          ...
                          var p = "x",
                            f =
                              Math.abs(l[0].offsetLeft) - u * (0.9 * o.width());
                        else
                          var p = "y",
                            f =
                              Math.abs(l[0].offsetTop) - u * (0.9 * o.height());
                        Z(e, f.toString(), {
                          dir: p,
                          scrollEasing: "mcsEaseInOut",
                        });
                      ...
                      if (
                        "x" === a.axis ||
                        ("yx" === a.axis && i.overflowed[1] && !i.overflowed[0])
                      )
                        var p = "x",
                          f =
                            35 === s
                              ? Math.abs(o.width() - l.outerWidth(!1))
                              : 0;
                      else
                        var p = "y",
                          f =
                            35 === s
                              ? Math.abs(o.height() - l.outerHeight(!1))
                              : 0;
                      Z(e, f.toString(), {
                        dir: p,
                        scrollEasing: "mcsEaseInOut",
            ...
            (V = function (e, i, a, r, n) {
              ...
              function f(t) {
                ...
                var i = "stepped" !== o.type,
                  ...
                  v =
                    "x" === o.dir[0]
                      ? h[1] + o.dir[1] * parseInt(o.scrollAmount)
                      : h[0] + o.dir[1] * parseInt(o.scrollAmount),
                  w = "auto" !== o.scrollAmount ? v : g;
                if (
                  (t && a < 17 && (w = "x" === o.dir[0] ? h[1] : h[0]),
                  Z(e, w.toString(), {
                    dir: o.dir[0],
                    scrollEasing:
                      r ||
                ...
                e instanceof Array
                  ? (a =
                      e.length > 1
                        ...
                        ? [null, e[0]]
                        : [e[0], null])
                  : ((a[0] = e.y ? e.y : e.x || "x" === i.axis ? null : e),
                  ...
                  case "number":
                    ...
                    if (-1 !== e.indexOf("+=")) {
                      ...
                      if ("first" === e || "last" === e) {
                        ...
                        s.css(c, e), h.update.call(null, a[0]);
                        return;
                      }
                    }
                }
            ...
            (U = function (e) {
              var i = t(this),
                ...
                n = t("#mCSB_" + a.idx + "_container");
              if (e) {
                clearTimeout(n[0].autoUpdate), et(n[0], "autoUpdate");
                return;
              }
              function s(e) {
                clearTimeout(n[0].autoUpdate), h.update.call(null, i[0], e);
              }
              (function e() {
                if (
                ...
                n[0].autoUpdate = setTimeout(function () {
                  ...
                  if (
                    ...
                    ((a.poll.change.n =
                      (!0 === r.advanced.updateOnSelectorChange &&
                        (r.advanced.updateOnSelectorChange = "*"),
                      (l = 0),
                    ...
                    (a.poll.change.o = a.poll.change.n), s(3);
                    return;
                  }
                  if (
                    r.advanced.updateOnContentResize &&
                    ((a.poll.size.n =
                      i[0].scrollHeight +
                      i[0].scrollWidth +
                      n[0].offsetHeight +
                    ...
                    (a.poll.size.o = a.poll.size.n), s(1);
                    return;
                  }
                  if (
                    r.advanced.updateOnImageLoad &&
                    !(
                      "auto" === r.advanced.updateOnImageLoad && "y" === r.axis
                    ) &&
                    ((a.poll.img.n = n.find("img").length),
            ...
            (Z = function (e, i, a) {
              var r,
                ...
                u = c.parent(),
                p = s.callbacks.onTotalScrollOffset
                  ? X.call(e, s.callbacks.onTotalScrollOffset)
                  : [0, 0],
                f = s.callbacks.onTotalScrollBackOffset
              ...
              if (
                ...
                "_resetY" !== i ||
                  n.contentReset.y ||
                  (C("onOverflowYNone") &&
                    s.callbacks.onOverflowYNone.call(e[0]),
                  (n.contentReset.y = 1)),
                "_resetX" !== i ||
                  n.contentReset.x ||
                  (C("onOverflowXNone") &&
                    s.callbacks.onOverflowXNone.call(e[0]),
                  (n.contentReset.x = 1)),
                "_resetY" !== i && "_resetX" !== i)
              ) {
                switch (
                  ((n.contentReset.y || !e[0].mcs) &&
                    n.overflowed[0] &&
                    (C("onOverflowY") && s.callbacks.onOverflowY.call(e[0]),
                    (n.contentReset.x = null)),
                  (n.contentReset.x || !e[0].mcs) &&
                    n.overflowed[1] &&
                    (C("onOverflowX") && s.callbacks.onOverflowX.call(e[0]),
                    (n.contentReset.x = null)),
                  s.snapAmount &&
                    (i =
                      Math.round(
                      ...
                      a.overwrite,
                      {
                        onStart: function () {
                          a.callbacks &&
                            ...
                            !n.tweenRunning &&
                            (C("onScrollStart") &&
                              (E(), s.callbacks.onScrollStart.call(e[0])),
                            (n.tweenRunning = !0),
                            _(h),
                            (n.cbOffsets = [
                              s.callbacks.alwaysTriggerOffsets || g >= v[0] + b,
                              s.callbacks.alwaysTriggerOffsets || g <= -S,
                            ]));
                        },
                        onUpdate: function () {
                          a.callbacks &&
                            a.onUpdate &&
                            C("whileScrolling") &&
                            (E(), s.callbacks.whileScrolling.call(e[0]));
                        },
                        onComplete: function () {
                          if (a.callbacks && a.onComplete) {
                            ...
                            c[0].onCompleteTimeout = setTimeout(function () {
                              C("onScroll") &&
                                (E(), s.callbacks.onScroll.call(e[0])),
                                C("onTotalScroll") &&
                                  w[1] >= v[1] - y &&
                                  n.cbOffsets[0] &&
                                  (E(), s.callbacks.onTotalScroll.call(e[0])),
                                C("onTotalScrollBack") &&
                                  w[1] <= x &&
                                  n.cbOffsets[1] &&
                                  (E(),
              ...
              function C(e) {
                return (
                  n && s.callbacks[e] && "function" == typeof s.callbacks[e]
                );
              }
              function E() {
                ...
                e[0].mcs = {
                  ...
                  draggerLeft: i[1],
                  topPct: Math.round(
                    (100 * Math.abs(t[0])) / (Math.abs(r[0]) - n[0])
                  ),
                  leftPct: Math.round(
                    (100 * Math.abs(t[1])) / (Math.abs(r[1]) - n[1])
                  ),
                  direction: a.dir,
                };
              }
            ...
            (J = function (e, t, i, a, r, n, s) {
              ...
              function w() {
                a > 0
                  ? ((g.currVal = (function (e, t, i, a, r) {
                      switch (r) {
                        case "linear":
                        case "mcsLinear":
                          return (i * e) / a + t;
                        case "mcsLinearOut":
                          return (e /= a), i * Math.sqrt(1 - --e * e) + t;
                        case "easeInOutSmooth":
                          if ((e /= a / 2) < 1) return (i / 2) * e * e + t;
              ...
              (g.stop = 0),
                ...
                (g.id = o(function e() {
                  g.stop ||
                    ...
                    w(),
                    f >= g.time &&
                      ((g.time = f > g.time ? f + l - (f - g.time) : f + l - 1),
                  ...
                  mcsInView:
                    ...
                    function (e) {
                      var i,
                        a,
                        r = t(e),
                        n = r.parents(".mCSB_container");
                      if (n.length)
                        return (
                          (i = n.parent()),
                          (a = [n[0].offsetTop, n[0].offsetLeft])[0] +
                            en(r)[0] >=
                            0 &&
                            a[0] + en(r)[0] < i.height() - r.outerHeight(!1) &&
                            a[1] + en(r)[1] >= 0 &&
                            a[1] + en(r)[1] < i.width() - r.outerWidth(!1)
                        );
                    },
                  mcsInSight:
                    t.expr[":"].mcsInSight ||
                    function (e, i, a) {
                      ...
                      if (d.length)
                        return (
                          ...
                          (s = [
                            d[0].offsetTop + en(o)[0],
                            d[0].offsetLeft + en(o)[1],
                          ]),
                          (n = [
                            d.parent()[0].offsetHeight,
      ...
      let v = n.default.forwardRef(function (e, t) {
        ...
        (i = v),
          M &&
            ...
            (i = n.default.createElement("a", null, i));
        let P = !1 !== w,
          ...
          { href: I, as: z } = n.default.useMemo(() => {
            ...
            return { href: e, as: h ? s.resolveHref(O, h) : t || e };
          }, [O, l, h]),
          D = n.default.useRef(I),
          $ = n.default.useRef(z);
        M && (a = n.default.Children.only(i));
        let H = M ? a && "object" == typeof a && a.ref : t,
          [R, N, j] = u.useIntersection({ rootMargin: "200px" }),
          G = n.default.useCallback(
            (e) => {
              ($.current !== z || D.current !== I) &&
                (j(), ($.current = z), (D.current = I)),
                R(e),
                H &&
                  ("function" == typeof H
                    ? H(e)
        ...
        if (!M || b || ("a" === a.type && !("href" in a.props))) {
          ...
          W.href =
            t ||
            f.addBasePath(
              o.addLocale(z, e, null == O ? void 0 : O.defaultLocale)
            );
        }
        return M
          ? n.default.cloneElement(a, W)
          : n.default.createElement("a", Object.assign({}, k, W), i);
      });
      (t.default = v),
        ("function" == typeof t.default ||
          ("object" == typeof t.default && null !== t.default)) &&
            ...
            (i = (function () {
              ...
              return (
                ...
                (e.prototype.set = function (e, t) {
                  var i, a, r, n;
                  for (n = this.keys, i = a = 0, r = n.length; a < r; i = ++a)
                    if (n[i] === e) {
                      this.values[i] = t;
                      return;
                    }
          ...
          (this.WOW = (function () {
            ...
            return (
              ...
              (r.prototype.start = function () {
                ...
                if (
                  ...
                  (this.boxes = function () {
                    ...
                    for (
                      e = 0,
                        a = this.element.querySelectorAll(
                  ...
                  if (this.disabled()) this.resetStyle();
                    ...
                    for (i = 0, a = (r = this.boxes).length; i < a; i++)
              ...
              (r.prototype.resetStyle = function () {
                var e, t, i, a, r;
                for (t = 0, a = this.boxes, r = [], i = a.length; t < i; t++)
                  (e = a[t]), r.push((e.style.visibility = "visible"));
                return r;
              }),
                  ...
                  (r = t[i]),
                    ...
                    a.push(
                      function () {
                        var t, a, s, l;
                        for (
                          t = 0, s = this.vendors, l = [], a = s.length;
                          t < a;
                          t++
                        )
                          (n = s[t]),
    ...
    2546: function (e, t, i) {
      ...
      let w = (0, a.forwardRef)(function (e, t) {
        let {
          ...
          x = !1,
          [C, E] = (0, a.useState)("swiper"),
          [T, _] = (0, a.useState)(null),
          [M, k] = (0, a.useState)(!1),
          P = (0, a.useRef)(!1),
          O = (0, a.useRef)(null),
          L = (0, a.useRef)(null),
            ...
            return (
              Object.keys(c).forEach((r) => {
                void 0 !== e[r] &&
                  (d.indexOf(r) >= 0
                    ? n(e[r])
                      ? ((i[r] = {}), (l[r] = {}), s(i[r], e[r]), s(l[r], e[r]))
                      : ((i[r] = e[r]), (l[r] = e[r]))
                    : 0 === r.search(/on[A-Z]/) && "function" == typeof e[r]
                    ? t
                      ? (a[`${r[2].toLowerCase()}${r.substr(3)}`] = e[r])
              ...
              { params: i, passedParams: l, rest: o, events: a }
            );
          })(y),
        ...
        O.current || q(), L.current && L.current.on("_beforeBreakpoint", F);
        let V = () => {
            !x &&
              j &&
              L.current &&
                ...
                (function ({
                  ...
                  if (
                    ...
                    w.includes("controller") &&
                      ...
                      b.controller &&
                      b.controller.control &&
                      (e.controller.control = b.controller.control),
                    a.includes("children") &&
                      t &&
                      C &&
                      b.virtual.enabled &&
              ...
              a.createElement(
                ...
                H.virtual
                  ? (function (e, t, i) {
                      ...
                      return c.map((t) =>
                        a.cloneElement(t, { swiper: e, style: n })
                      );
                    })(L.current, G, T)
                  : G.map((e, t) =>
                      a.cloneElement(e, {
    ...
    9360: function (e, t, i) {
            ...
            for (let i = 0, a = e.length; i < a; i += 1) {
              ...
              void 0 !== n &&
                ...
                (m(t[a]) && m(r[a])
                  ...
                  : !m(t[a]) && m(r[a])
                  ? ((t[a] = {}),
                    r[a].__swiper__ ? (t[a] = r[a]) : g(t[a], r[a]))
                  : (t[a] = r[a]));
            }
          }
        }
        ...
        let o = t > n ? "next" : "prev",
          ...
          c = () => {
            ...
            let o = Math.max(Math.min((a - s) / l, 1), 0),
              u = n + (0.5 - Math.cos(o * Math.PI) / 2) * (t - n);
            if (
      ...
      function E(e, t) {
        let i = [],
          a = e.parentElement;
        for (; a; )
          t ? a.matches(t) && i.push(a) : i.push(a), (a = a.parentElement);
        return i;
      }
      function T(e, t, i) {
        let a = p();
      ...
      function k(e) {
        ...
        if (
          !l ||
          (!n.simulateTouch && "mouse" === e.pointerType) ||
        ...
        let d = o.target;
        if (
          ("wrapper" === n.touchEventsTarget && !t.wrapperEl.contains(d)) ||
      ...
      function P(e) {
        ...
        if (n.touchReleaseOnEdges && !n.loop) {
          if (a.isVertical()) {
            if (
              (m < s.startY && a.translate <= a.maxTranslate()) ||
              (m > s.startY && a.translate >= a.minTranslate())
            ) {
              (r.isTouched = !1), (r.isMoved = !1);
              return;
            }
          } else if (
            (f < s.startX && a.translate <= a.maxTranslate()) ||
            (f > s.startX && a.translate >= a.minTranslate())
          )
            return;
        }
        if (
        ...
        if (
          (r.allowTouchCallbacks && a.emit("touchMove", d),
        ...
        if (
          a.params.threshold &&
          Math.sqrt(g ** 2 + v ** 2) < a.params.threshold
        )
          return;
        if (void 0 === r.isScrolling) {
          ...
          (a.isVertical() && s.currentX === s.startX)
            ? (r.isScrolling = !1)
            : g * g + v * v >= 25 &&
              ((e = (180 * Math.atan2(Math.abs(v), Math.abs(g))) / Math.PI),
              (r.isScrolling = a.isHorizontal()
                ? e > n.touchAngle
                : 90 - e > n.touchAngle));
        }
        if (
          (r.isScrolling && a.emit("touchMoveOpposite", d),
        ...
        n.oneWayMovement &&
          ((w = Math.abs(w) * (l ? 1 : -1)), (b = Math.abs(b) * (l ? 1 : -1))),
          (s.diff = w),
          (w *= n.touchRatio),
          l && ((w = -w), (b = -b));
        ...
        if (!r.isMoved) {
          if (
            (y && a.loopFix({ direction: a.swipeDirection }),
        ...
        r.isMoved &&
          S !== a.touchesDirection &&
          y &&
          Math.abs(w) >= 1 &&
          (a.loopFix({ direction: a.swipeDirection, setTranslate: !0 }),
          (t = !0)),
          a.emit("sliderMove", d),
          (r.isMoved = !0),
              ...
              r.currentTranslate > a.minTranslate() &&
                ...
                n.resistance &&
                  (r.currentTranslate =
                    a.minTranslate() -
                    1 +
                    (-a.minTranslate() + r.startTranslate + w) ** C)))
            : w < 0 &&
              (y &&
                !t &&
                r.currentTranslate <
                  (n.centeredSlides
                    ? a.maxTranslate() + a.size / 2
                    : a.maxTranslate()) &&
                a.loopFix({
                  direction: "next",
                  setTranslate: !0,
              ...
              r.currentTranslate < a.maxTranslate() &&
                ...
                n.resistance &&
                  (r.currentTranslate =
                    a.maxTranslate() +
                    1 -
                    (a.maxTranslate() - r.startTranslate - w) ** C))),
        ...
        n.followFinger &&
          !n.cssMode &&
          (((n.freeMode && n.freeMode.enabled && a.freeMode) ||
      ...
      function O(e) {
        ...
        if (!d || (!n.simulateTouch && "mouse" === e.pointerType)) return;
        let c = e;
        if (
        ...
        for (
          ...
          void 0 !== o[e + i]
            ? t >= o[e] && t < o[e + i] && ((m = e), (g = o[e + i] - o[e]))
            : t >= o[e] && ((m = e), (g = o[o.length - 1] - o[o.length - 2]));
        }
        let v = null,
          w = null;
        n.rewind &&
        ...
        if (p > n.longSwipesMs) {
          ...
          "next" === i.swipeDirection &&
            (b >= n.longSwipesRatio
              ? i.slideTo(n.rewind && i.isEnd ? v : m + S)
              : i.slideTo(m)),
          ...
          e
            ? c.target === i.navigation.nextEl
              ? i.slideTo(m + S)
              : i.slideTo(m)
            : ("next" === i.swipeDirection && i.slideTo(null !== v ? v : m + S),
      ...
      let j = {
          eventsEmitter: {
            ...
            emit(...e) {
              ...
              "string" == typeof e[0] || Array.isArray(e[0])
                ? ((t = e[0]), (i = e.slice(1, e.length)), (a = r))
                : ((t = e[0].events), (i = e[0].data), (a = e[0].context || r)),
                i.unshift(a);
          ...
          update: {
            ...
            updateSlides: function () {
              ...
              if (
                ...
                o &&
                  ...
                  (n.style.width = `${t.virtualSize + r.spaceBetween}px`),
                r.setWrapperSize &&
                  (n.style[i("width")] = `${t.virtualSize + r.spaceBetween}px`),
            ...
            updateSlidesProgress: function (e = (this && this.translate) || 0) {
              ...
              for (let e = 0; e < a.length; e += 1) {
                ...
                let d =
                    (s + (i.centeredSlides ? t.minTranslate() : 0) - o) /
                    (l.swiperSlideSize + i.spaceBetween),
                  c =
                    (s - n[0] + (i.centeredSlides ? t.minTranslate() : 0) - o) /
                    (l.swiperSlideSize + i.spaceBetween),
                  u = -(s - o),
            ...
            updateSlidesClasses: function () {
              ...
              if (
                ...
                } else e = s(`[data-swiper-slide-index="${r}"]`);
              } else e = t[r];
              if (e) {
            ...
            updateActiveIndex: function (e) {
              ...
              if ((t >= n.length && (t = n.length - 1), c === l)) {
              ...
              (i =
                a.virtual && s.virtual.enabled && s.loop
                  ? u(c)
                  : a.slides[c]
                  ? parseInt(
                      a.slides[c].getAttribute("data-swiper-slide-index") || c,
                      10
                    )
                  : c),
                Object.assign(a, {
          ...
          translate: {
            getTranslate: function (e = this.isHorizontal() ? "x" : "y") {
              ...
              let n = (function (e, t = "x") {
                ...
                return (
                  n.WebKitCSSMatrix
                    ? ((a = s.transform || s.webkitTransform).split(",")
                        .length > 6 &&
                        (a = a
                          .split(", ")
                          .map((e) => e.replace(",", "."))
          ...
          slide: {
            slideTo: function (e = 0, t = this.params.speed, i = !0, a, r) {
              ...
              if (
                ...
                return !1;
              if (
                (l !== (u || 0) && i && s.emit("beforeSlideChangeStart"),
                s.updateProgress(b),
                ...
                return (
                  ...
                  "reset" !== n &&
                    (s.transitionStart(i, n), s.transitionEnd(i, n)),
                  !1
                );
              if (o.cssMode) {
                let e = s.isHorizontal(),
            ...
            slideNext: function (e = this.params.speed, t = !0, i) {
              ...
              return n.rewind && a.isEnd
                ? a.slideTo(0, e, t, i)
                : a.slideTo(a.activeIndex + o, e, t, i);
            },
            slidePrev: function (e = this.params.speed, t = !0, i) {
              ...
              if (
                (void 0 !== m &&
                  ((g = s.indexOf(m)) < 0 && (g = a.activeIndex - 1),
                  "auto" === r.slidesPerView &&
                    1 === r.slidesPerGroup &&
                ...
                (e = parseInt(
                  ...
                  i.centeredSlides
                    ? n < t.loopedSlides - r / 2 ||
                      ...
                      ? (t.loopFix(),
                        (n = C(
                          S(a, `${s}[data-swiper-slide-index="${e}"]`)[0]
                        )),
                        f(() => {
                          t.slideTo(n);
                        }))
          ...
          events: {
            attachEvents: function () {
              ...
              (e.onTouchStart = k.bind(e)),
                ...
                (e.onClick = B.bind(e)),
                (e.onLoad = z.bind(e)),
                D || (t.addEventListener("touchstart", $), (D = !0)),
                H(e, "on");
            },
          ...
          breakpoints: {
            ...
            getBreakpoint: function (e, t = "window", i) {
              ...
              for (let e = 0; e < s.length; e += 1) {
                ...
                "window" === t
                  ? r.matchMedia(`(min-width: ${l}px)`).matches && (a = n)
                  : l <= i.clientWidth && (a = n);
              }
              return a || "max";
            },
          ...
          classes: {
            addClasses: function () {
              ...
              e.push(...n), a.classList.add(...e), this.emitContainerClasses();
            },
      ...
      class W {
        constructor(...e) {
          ...
          if (
            ...
            let e = [];
            return (
              a.querySelectorAll(i.el).forEach((t) => {
                let a = g({}, i, { el: t });
                e.push(new W(a));
              }),
              e
        ...
        slidesPerViewDynamic(e = "current", t = !1) {
          ...
          if (i.centeredSlides) {
            ...
            for (let i = l + 1; i < a.length; i += 1)
              a[i] &&
                !e &&
                ((t += a[i].swiperSlideSize), (o += 1), t > s && (e = !0));
      ...
      function q({ swiper: e, extendParams: t, on: i, emit: a }) {
        ...
        function l(t, i) {
          ...
          return r.cache && e.virtual.cache[i]
            ? e.virtual.cache[i]
            : (r.renderSlide
                ? "string" == typeof (a = r.renderSlide.call(e, t, i)) &&
                  ((s.innerHTML = a), (a = s.children[0]))
                : (a = e.isElement
                    ? y("swiper-slide")
                    : y("div", e.params.slideClass)),
        ...
        function o(t) {
          ...
          (i = e.rtlTranslate ? "right" : e.isHorizontal() ? "left" : "top"),
            d
              ? ((r = Math.floor(s / 2) + o + p),
                (n = Math.floor(s / 2) + o + u))
              : ((r = s + (o - 1) + p), (n = (c ? s : o) + u));
          let b = w - n,
            y = w + r;
          c || ((b = Math.max(b, 0)), (y = Math.min(y, m.length - 1)));
          ...
          if (
            (c && w >= n
              ? ((b -= n), d || (x += e.slidesGrid[0]))
              : c && w < n && ((b = -n), d && (x += e.slidesGrid[0])),
          ...
          if (e.params.virtual.renderExternal) {
            e.params.virtual.renderExternal.call(e, {
              ...
              slides: (function () {
                let e = [];
                for (let t = b; t <= y; t += 1) e.push(m[t]);
                return e;
              })(),
            }),
        ...
        i("beforeInit", () => {
          ...
          if (e.params.virtual.enabled) {
            if (void 0 === e.passedParams.virtual.slides) {
              let i = e.slidesEl.querySelectorAll(
          ...
          i("init update resize", () => {
            e.params.virtual.enabled &&
              e.params.cssMode &&
              v(e.wrapperEl, "--swiper-virtual-size", `${e.virtualSize}px`);
          }),
          Object.assign(e.virtual, {
      ...
      function V({ swiper: e, extendParams: t, on: i, emit: a }) {
        ...
        function m(t) {
          ...
          let w = 0,
            ...
            S =
              ...
              "axis" in i && i.axis === i.HORIZONTAL_AXIS && ((s = l), (l = 0)),
              (d = 10 * s),
              (c = 10 * l),
              "deltaY" in i && (c = i.deltaY),
              "deltaX" in i && (d = i.deltaX),
              i.shiftKey && !d && ((d = c), (c = 0)),
              (d || c) &&
                i.deltaMode &&
                (1 === i.deltaMode
                  ? ((d *= 40), (c *= 40))
              ...
              d && !s && (s = d < 1 ? -1 : 1),
              c && !l && (l = c < 1 ? -1 : 1),
              { spinX: s, spinY: l, pixelX: d, pixelY: c });
          if (m.forceToAxis) {
            if (e.isHorizontal()) {
          ...
          if (
            ...
            let t = { time: h(), delta: Math.abs(w), direction: Math.sign(w) },
              i =
                n &&
                t.time < n.time + 500 &&
                t.delta <= n.delta &&
        ...
        function g(t) {
          let i = e.el;
          "container" !== e.params.mousewheel.eventsTarget &&
            (i = document.querySelector(e.params.mousewheel.eventsTarget)),
            i[t]("mouseenter", d),
            i[t]("mouseleave", c),
            i[t]("wheel", m);
        }
        ...
        return (
          e.params.createElements &&
            Object.keys(a).forEach((r) => {
              if (!i[r] && !0 === i.auto) {
                let n = S(e.el, `.${a[r]}`)[0];
                n || (((n = y("div", a[r])).className = a[r]), e.el.append(n)),
                  (i[r] = n),
                  (t[r] = n);
              }
            }),
      ...
      function Y({ swiper: e, extendParams: t, on: i, emit: a }) {
        ...
        function s(t, i) {
          ...
          (t = r(t)).forEach((t) => {
            t &&
              (t.classList[i ? "add" : "remove"](a.disabledClass),
        ...
        function u() {
          ...
          t.forEach((e) => a(e, "next")), i.forEach((e) => a(e, "prev"));
        }
        i("init", () => {
      ...
      function K({ swiper: e, extendParams: t, on: i, emit: a }) {
        ...
        function u() {
          ...
          if (
            ...
            if (
              (n.dynamicBullets &&
                ((r = T(u[0], e.isHorizontal() ? "width" : "height", !0)),
                c.forEach((t) => {
                  t.style[e.isHorizontal() ? "width" : "height"] = `${
                    r * (n.dynamicMainBullets + 4)
                  }px`;
                }),
                n.dynamicMainBullets > 1 &&
                  void 0 !== e.previousIndex &&
                  ((s += t - (e.previousIndex || 0)) > n.dynamicMainBullets - 1
          ...
          c.forEach((i, r) => {
            if (
              ("fraction" === n.type &&
                (i.querySelectorAll(U(n.currentClass)).forEach((e) => {
            ...
            "custom" === n.type && n.renderCustom
              ? ((i.innerHTML = n.renderCustom(e, t + 1, p)),
                0 === r && a("paginationRender", i))
              : (0 === r && a("paginationRender", i), a("paginationUpdate", i)),
              e.params.watchOverflow &&
                e.enabled &&
                i.classList[e.isLocked ? "add" : "remove"](n.lockClass);
          });
        }
        function p() {
          ...
          "fraction" === t.type &&
            ...
            r.forEach((i) => {
              "custom" !== t.type && (i.innerHTML = n || ""),
                "bullets" === t.type &&
                  (e.pagination.bullets = [
                    ...i.querySelectorAll(U(t.bulletClass)),
                  ]);
            }),
        ...
        i("init", () => {
          !1 === e.params.pagination.enabled ? g() : (f(), p(), u());
        }),
          i("activeIndexChange", () => {
      ...
      function Z({ swiper: e, extendParams: t, on: i, emit: a, params: r }) {
        ...
        let b = () => {
          ...
          E = (t, i) => {
            ...
            if (((e.autoplay.paused = !0), i)) {
              f && (l = e.params.autoplay.delay), (f = !1), r();
              return;
            }
        ...
        i("init", () => {
          e.params.autoplay.enabled &&
            (P(), L(), (v = new Date().getTime()), x());
        }),
          i("destroy", () => {
            O(), B(), e.autoplay.running && C();
          }),
          i("beforeTransitionStart", (t, i, a) => {
            !e.destroyed &&
              e.autoplay.running &&
              (a || !e.params.autoplay.disableOnInteraction ? E(!0, !0) : C());
          }),
          i("sliderFirstMove", () => {
          ...
          i("touchEnd", () => {
            if (!e.destroyed && e.autoplay.running && d) {
              ...
              u && e.params.cssMode && T(), (u = !1), (d = !1);
            }
          }),
          i("slideChange", () => {
            !e.destroyed && e.autoplay.running && (f = !0);
          }),
          Object.assign(e.autoplay, { start: x, stop: C, pause: E, resume: T });
      }
      function J({ swiper: e, extendParams: t }) {
        ...
        e.grid = { initSlides: n, updateSlide: s, updateWrapperSize: l };
      }
      function Q(e) {
        let t;
        let {
        ...
        r("beforeInit", () => {
          ...
          r("virtualUpdate", () => {
            a.params.effect === i &&
              (a.slides.length || (t = !0),
              requestAnimationFrame(() => {
                t && a.slides && a.slides.length && (n(), (t = !1));
              }));
          });
      }
      function ee(e, t) {
      ...
      function et({
        ...
        if (e.params.virtualTranslate && 0 !== t) {
          ...
          (a
            ? i
            : i.filter((e) => {
                let t = e.classList.contains("swiper-slide-transform")
                  ? n(e)
                  : e;
                return C(t) === r;
              })
            ...
            (a = () => {
              ...
              i.addEventListener("transitionend", function e(t) {
                t.target === i &&
                  (a.call(i, t), i.removeEventListener("transitionend", e));
              });
          });
        }
      }
